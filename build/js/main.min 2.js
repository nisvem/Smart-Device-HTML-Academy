  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      setTimeout(function () {
        ...
        modal.querySelector('.form__input[data-input-name]').focus();
...
document.querySelectorAll('[data-toggle]').forEach(function (toggle) {
  var text = toggle.querySelector('[data-toggle-text]');
  var btn = toggle.querySelector('[data-toggle-btn]');
...
forms.forEach(function (form) {
  ...
  form.addEventListener('submit', function (evt) {
    ...
    if (phone.value.length < 17 || !name.value || !check.checked) {
      ...
      evt.preventDefault(); // Тут отправить форму Ajax'ом
